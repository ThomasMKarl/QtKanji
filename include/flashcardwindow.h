...
public:
  static FlashcardWindow *createFlashcardWindow(bool randomize_, bool fromCardbox_, DataHandler dataHandler_,
                                                SharedBoxes &boxes_, SharedTable &table_, QWidget *parent = 0)
  {
    return new FlashcardWindow{randomize_, fromCardbox_, std::move(dataHandler_), boxes_, table_, parent};
  }
...
private:
  explicit FlashcardWindow(bool randomize_, bool fromCardbox_, DataHandler dataHandler_, SharedBoxes &boxes_,
                           SharedTable &table_, QWidget *parent = 0);
  ...
  QLineEdit displayImi{}, displayKun{}, displayOn{};
  QLabel Sign{"漢字:"}, Imi{"いみ:"}, Kun{"くん:"}, On{"おん:"}, hid{}, allGraphemes{}, gids{}, radicals{},
      Success{"Success!"}, Failure{"Failure!"}, Success2{}, Failure2{}, Rate{}, Rate2{}, cards{};
  QPushButton submitButton{"submit"}, addButton{"add to cardbox"}, continueButton{"continue"},
